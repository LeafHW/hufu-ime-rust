...
- 随仓库分发的码表与输入法资源来自：虎码官方发布（<https://huma.ysepan.com>）、虎爪输入法 TigerClaw（<https://github.com/lvyww/tigerclaw>，GPL-3.0）；随本仓库分发并保留原项目声明，逐文件来源见 [docs/asset-sources.md](docs/asset-sources.md)
